...
namespace Bookstore.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Index(string Title = null)
        {
            ...
            // Return all books if no search term is provided, otherwise search.
            mymodel.AllBooks = await Search(Title);
            return View(mymodel);
        }
        ...
        public async Task<List<Book>> Search(string? Title)
        {
            ...
            {
                // Return all books if Title is null or empty
                return await _context.Books.ToListAsync();
            }

            // Return search results based on title
